<template>
    <div class="DatePicker" ref="pickerdom">
...
export default {
    ...
    data() {
        return {
            ...
            yearRight: new Date().getFullYear(),
            ...
            Times: this.value,
            disabledTimeData: this.disabledTime,
            clashTimeData: this.clashTime,
    ...
    methods: {
        ...
        // 确定
        dateSubmit() {
            // if (this.clashTimeData.length > 0) {
            //     let alertText = [];
            //     this.clashTimeData.forEach((item) => {
            //         alertText.push(new Date(item).format("yyyy-MM-dd"));
            //     });
            //     alert("日期：" + alertText.join(",") + "存在冲突,请处理后提交");
            //     return;
            // }
            this.$emit("input", this.Times);
            this.dataRang = false;
